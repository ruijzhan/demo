...
import (
	...
	"github.com/ruijzhan/demo/http/framework/gin/binding"
	testdata "github.com/ruijzhan/demo/http/framework/gin/testdata/protoexample"
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/ruijzhan/demo/http/framework/gin.handlerNameTest$", c.HandlerName())
}
